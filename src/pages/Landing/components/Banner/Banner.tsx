...
function Banner({}: Props) {
    return (
        <div className="bg-[url('./img_banner.jpg')] bg-cover bg-center bg-no-repeat relative w-full pt-[100px] pb-[100px] px-3 md:px-0">
            ...
            <div className="relative text-center text-white z-[1]">
                <h1 className="capitalize font-bold text-[35px] md:text-[50px]">Welcome To Education</h1>
